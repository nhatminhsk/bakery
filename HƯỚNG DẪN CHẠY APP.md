...
## 4. Chay chatbot API
Tu thu muc `D:\QLDA\bakery-chatbot`:
```bash
cd D:\QLDA\bakery-chatbot
& D:\QLDA\.venv\Scripts\Activate.ps1
uvicorn api.main:app --host 0.0.0.0 --port 8000 --reload
```

Neu da dang o dung thu muc va da activate moi truong roi, chi can chay:
```bash
uvicorn api.main:app --host 0.0.0.0 --port 8000 --reload
```
